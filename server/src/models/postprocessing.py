...
2. Removed RemovingTooTransparentBordersHardAndBlurringHardBordersTwo class.
3. Removed logging related code.
4. Moved __init__ imports to the top of the file.
-- humanova
